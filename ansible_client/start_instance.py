...
instance_prod = nova.servers.create(name="group_16_prod"+str(identifier), image=image, flavor=flavor, key_name='babi1816',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="group_16_dev"+str(identifier), image=image, flavor=flavor, key_name='babi1816',userdata=userdata_dev, nics=nics,security_groups=secgroups)
